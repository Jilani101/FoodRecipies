...
extension Recipes {
    static let recipes: [Recipes] = [
        ...
        Recipes(id: UUID().uuidString, recipeName: "Classic Greek Salad CHINESE", recipeImage: "img_recipe_3", cookingTime: "10", rating: Ratings.ratings[2], user: User.users[2], recipeType: .chinese),
        ...
        Recipes(id: UUID().uuidString, recipeName: "Classic Greek Salad ASIAN", recipeImage: "img_recipe_5", cookingTime: "20", rating: Ratings.ratings[4], user: User.users[4], recipeType: .asian),
        ...
        Recipes(id: UUID().uuidString, recipeName: "Classic Greek Salad ITALIAN", recipeImage: "img_recipe_1", cookingTime: "15", rating: Ratings.ratings[0], user: User.users[0], recipeType: .italian),
        
        Recipes(id: UUID().uuidString, recipeName: "Classic Greek Salad INDIAN", recipeImage: "img_recipe_2", cookingTime: "5", rating: Ratings.ratings[1], user: User.users[1], recipeType: .indian),
        ...
        Recipes(id: UUID().uuidString, recipeName: "Classic Greek Salad INDIAN", recipeImage: "img_recipe_5", cookingTime: "20", rating: Ratings.ratings[4], user: User.users[4], recipeType: .indian),
