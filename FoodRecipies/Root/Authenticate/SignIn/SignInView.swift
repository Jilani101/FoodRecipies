    ...
    var body: some View {
        NavigationStack {
            VStack {
                ...
                // text fields
                VStack(spacing: 30) {
                    UserTextFieldsView(textFieldType: $email, textFieldTitle: "Email", textFieldPlaceholder: "Enter email", textFieldHeight: 55)
                    UserTextFieldsView(textFieldType: $email, textFieldTitle: "Password", textFieldPlaceholder: "Enter password", textFieldHeight: 55)
                }
